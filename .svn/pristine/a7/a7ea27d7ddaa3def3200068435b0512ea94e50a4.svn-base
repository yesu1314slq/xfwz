...
<head>
	...
	<style type="text/css">
		...
		#wz_title {color: #000000;font-size: 20px;font-weight: bold;margin: 0;text-align:center;}
		#wz_date {color: #8C8C8C;font-size: 12px;text-align:center;display:block;margin-top:10px;}
		.wz_fengmian {margin: 0px 0;}
		.wz_content {color: #3E3E3E;line-height: 1.5;margin-top:20px;overflow: hidden;width: 100%;font-size: 15px;}
		...
		#ui-header {width: 100%;height: 58px;line-height: 46px;z-index: 3;position: absolute;left: 0;top: 0;right: 0;}
		#ui-header .fixed {display: block;margin: 0 auto;min-width: 320px;height: 58px;line-height:58px;background:#78a2f8;top: 0;border-bottom: 1px solid #D1D1D1;box-shadow: 0 0 10px 2px rgba(0, 0, 0, 0.15);-moz-box-shadow: 0 0 10px 2px rgba(0, 0, 0, 0.15);-webkit-box-shadow: 0 0 10px 2px rgba(0, 0, 0, 0.15);}
		#ui-header .fixed a{positon:relative;top:5px;}
		...
		<div class="row-fluid">
			<div class="span12">
				<div>
					...
					<span id="wz_date"> 发布者：${article.createBy.name} &nbsp;  点击数：${article.hits} &nbsp; 发布时间：<fmt:formatDate value="${article.createDate}" pattern="yyyy-MM-dd"/> &nbsp; <%-- 更新时间：<fmt:formatDate value="${article.updateDate}" pattern="yyyy-MM-dd HH:mm:ss"/> --%></span>
