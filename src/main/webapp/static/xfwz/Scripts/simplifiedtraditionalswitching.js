...
function returnUpdateImageHref(){
	
		$("img[simplified]").each(function(){ 
			
			$(this)[0].src = $(this)[0].src.replace("/images_traditional/","/images/");
		});
		...
		for(var i=1;i<6;i++){
			try{
				var url = $(".main_view_"+i).css("background-image").replace("/images_traditional/","/images/");
				$(".main_view_"+i).css("background-image",url);
			}catch(e){
...
function updateImageHref(){
	
		$("img[simplified]").each(function(){ 
			
			$(this)[0].src = $(this)[0].src.replace("/images/","/images_traditional/");
		});

		for(var i=1;i<6;i++){
			try{	
				var url = $(".main_view_"+i).css("background-image").replace("/images/","/images_traditional/");
				$(".main_view_"+i).css("background-image",url);
			}catch(e){
